# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-11-07 21:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conditions', models.ManyToManyField(blank=True, null=True, to='core.StorageCondition')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sc_essential', models.CommaSeparatedIntegerField(blank=True, max_length=50, null=True)),
                ('sc_favorable', models.CommaSeparatedIntegerField(blank=True, max_length=50, null=True)),
                ('sc_unfavorable', models.CommaSeparatedIntegerField(blank=True, max_length=50, null=True)),
                ('sc_intolerable', models.CommaSeparatedIntegerField(blank=True, max_length=50, null=True)),
                ('lossfactor', core.fields.PercentField(default=0)),
                ('official', models.PositiveSmallIntegerField(blank=True, null=True)),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.ProductCat')),
            ],
            bases=('core.consumable',),
        ),
        migrations.AddField(
